...
[ARRO] = LAYOUT_ergodox(
  ...
  KC_NO,   KC_NO,   LCTL(KC_X), LCTL(KC_C), LCTL(KC_V),  KC_NO,   KC_NO,
  KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,
                                               KC_NO,   KC_NO,
                                                        KC_NO,
                                   _______,  _______,   KC_NO,
...
[NUMS] = LAYOUT_ergodox(
  ...
  KC_NO,   KC_NO,   KC_7,    KC_8,    KC_9,    S(KC_8), KC_NO,
           KC_NO,   KC_4,    KC_5,    KC_6,    KC_MINS, _______,
  KC_NO,   KC_NO,   KC_1,    KC_2,    KC_3,    S(KC_EQL),KC_NO,
